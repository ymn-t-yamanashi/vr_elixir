...
## ドキュメント
- `resonite_link_ex/docs/design/基本設計.md`: 目的、対象範囲、できること、全体方針
- `resonite_link_ex/docs/design/詳細設計.md`: ResoniteLink 公式モデル準拠の詳細設計
- `resonite_link_ex/docs/rules/PJルール.md`: プロジェクト運用ルール
